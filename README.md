...
| File | Description |
|------|-------------|
| `workout-reference-guide.html` | Workout combos, strap routine, targeted practices |
| `fitness-ecosystem-master-plan-v1.2.html` | The north star document |
| `calisthenics-master-plan-v2.0.html` | Push-up and pistol squat progressions |
| `fitness-nutrition-systems-v3.1.html` | Protein strategy and Smoothie Lab |
